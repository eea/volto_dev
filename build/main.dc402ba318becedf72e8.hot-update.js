...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Edit, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.handleKeyDown = function (e, index, block, node) {
        ...
        console.log('keydown', node, block, disableEnter, index);

        if (e.key === 'ArrowUp' && !disableArrowUp) {
          _this2.onFocusPreviousBlock(block, node);

          e.preventDefault();
        }

        if (e.key === 'ArrowDown' && !disableArrowDown) {
          _this2.onFocusNextBlock(block, node);

          e.preventDefault();
        }

        if (e.key === 'Enter' && !disableEnter) {
          _this2.onAddBlock('text', index + 1);
    ...
    value: function onChange(editorState) {
      if (!Object(lodash__WEBPACK_IMPORTED_MODULE_14__["isEqual"])(Object(draft_js__WEBPACK_IMPORTED_MODULE_12__["convertToRaw"])(editorState.getCurrentContent()), Object(draft_js__WEBPACK_IMPORTED_MODULE_12__["convertToRaw"])(this.state.editorState.getCurrentContent()))) {
        this.props.onChangeBlock(this.props.block, _objectSpread({}, this.props.data, {
          text: Object(draft_js__WEBPACK_IMPORTED_MODULE_12__["convertToRaw"])(editorState.getCurrentContent())
        }));
      }
    ...
    value: function render() {
      ...
      var editorState = this.state.editorState; // console.log('in editor', this.props.selected, this.props.block)
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        ...
        onClick: function onClick(e) {
          _this3.props.onSelectBlock(_this3.props.block);
        } // onKeyPress={(e)=> {
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(Edit, "defaultProps", {
  detached: true,
  handleKeyDown: function handleKeyDown(e, index, block, node) {
    ...
    if (e.key === 'ArrowUp' && !disableArrowUp) {
      Edit.onFocusPreviousBlock(block, node);
      e.preventDefault();
    }

    if (e.key === 'ArrowDown' && !disableArrowDown) {
      Edit.onFocusNextBlock(block, node);
      e.preventDefault();
    }

    if (e.key === 'Enter' && !disableEnter) {
      Edit.onAddBlock('text', index + 1);
      e.preventDefault();
    }
  }
});
...
//# sourceMappingURL=main.dc402ba318becedf72e8.hot-update.js.map