...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Form, [{
    key: "handleOpen",
    value: function handleOpen(tileid) {
      this.setState({
        showModal: true,
        currentBlock: tileid,
        tileHeights: {}
    ...
    value: function handleCloseEditor(blockData) {
      ...
      var tileid = this.state.currentBlock;
      var formData = this.state.formData;
      var blocksFieldname = Object(_plone_volto_helpers__WEBPACK_IMPORTED_MODULE_19__["getBlocksFieldname"])(formData);
      this.setState({
        formData: _objectSpread({}, this.state.formData, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()({}, blocksFieldname, _objectSpread({}, this.state.formData[blocksFieldname], _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()({}, tileid, blockData || null)))),
        showModal: false,
        preview: true
      }, function () {
    ...
    key: "onShowBlock",
    value: function onShowBlock(tileid, height) {
      var _this3 = this;
      ...
      var blockData = formData[blocksFieldname][tileid];
      ...
      switch (sizing) {
        case 'fit-content':
          this.setState(function (state, props) {
            ...
            console.log('height of node', height, lh, tileid, _this3.state);
          });
          break;
        // case 'min-height':
    ...
    key: "getBlockClass",
    value: function getBlockClass(tile) {
      return 'tile-info-data tile-edit-' + (tile.mosaic_box_sizing || 'fit-content');
    }
  }, {
    key: "createElement",
    value: function createElement(el) {
      var tileid = el.i; // const removeStyle = {
      //   position: 'absolute',
      //   right: '2px',
      //   top: 0,
      //   cursor: 'pointer',
      ...
      var i = el.add ? '+' : el.i;
      var ref = this.state.refs[tileid];
    ...
    value: function renderEditBlockPlaceholder(el, tileid) {
      var _this7 = this;

      var formData = this.state.formData;
      var blocksFieldname = Object(_plone_volto_helpers__WEBPACK_IMPORTED_MODULE_19__["getBlocksFieldname"])(formData);
      var tile = formData[blocksFieldname][tileid];
      var hasData = tile['@type'] !== 'text';
      var i = el.add ? '+' : el.i; // what is this?

      var title = '';

      if (!_src_config__WEBPACK_IMPORTED_MODULE_32__["blocks"].blocksConfig[tile['@type']]) {
        console.log('could not find configuration for this tile type', tile['@type']);
        title = 'broken tile';
      } else {
        title = tile.mosaic_tile_title || _src_config__WEBPACK_IMPORTED_MODULE_32__["blocks"].blocksConfig[tile['@type']].title;
      }
      ...
      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
        ...
        onClick: function onClick() {
          return _this7.handleOpen(tileid);
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 556
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(LayoutToolbar, [{
    ...
    value: function render() {
      ...
      }, "Preview tiles"))), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Grid"].Column, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 96
        }
...
/***/ "./volto-mosaic/src/components/manage/TileEditor.jsx":
false,

/***/ "./volto-mosaic/src/components/manage/TileMetadataEditor.jsx":
false,

/***/ "./volto-mosaic/src/components/manage/TileStyleSelectWidget.jsx":
false,
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(BlockViewWrapper, [{
    ...
    value: function render() {
      ...
      var tileid = this.props.tileid;
      var tilesFieldname = Object(_plone_volto_helpers__WEBPACK_IMPORTED_MODULE_15__["getBlocksFieldname"])(formData);
      var blockData = formData[tilesFieldname][tileid];
      ...
      var tiletype = blockData['@type'].toLowerCase();

      if (!_src_config__WEBPACK_IMPORTED_MODULE_12__["blocks"].tilesConfig[tiletype]) {
        console.log('Block configuration not found', tiletype);
        return '';
      }

      var Block = null;
      Block = _src_config__WEBPACK_IMPORTED_MODULE_12__["blocks"].tilesConfig[tiletype].view;
      var style = blockData.mosaic_box_style || 'default-tile';
      var klass = 'tile-wrapper ' + style;
      ...
      }, blockData.tile_title && blockData.show_tile_title && react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("h5", {
        className: "title-title",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 57
        }
      }, blockData.tile_title), react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(Block, {
        key: tileid,
        properties: formData,
        data: blockData,
        __source: {
    ...
    value: function getHeight() {
      ...
      var child = node && node.querySelector('.tile-wrapper > *'); // console.log('get height', node);
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        ...
        var height = _this2.getHeight(); // console.log('componentDidMount', this.props.tileid, height);


        _this2.props.showUpdate(_this2.props.tileid, height);
      });
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      this.setState({
        ...
        var height = _this3.getHeight(); // console.log('componentDidUpdate default code', this.props.tileid, height);


        _this3.props.showUpdate(_this3.props.tileid, height);
      });
    }
  }]);
...
function (_Component2) {
  ...
  function View(props) {
    ...
    var tilesLayoutFieldname = Object(_plone_volto_helpers__WEBPACK_IMPORTED_MODULE_15__["getBlocksLayoutFieldname"])(content);
    var layout = content[tilesLayoutFieldname];
    ...
    value: function onBlockShowUpdate(tileid, height) {
      ...
      this.setState(function (state, props) {
        var newState = _objectSpread({}, state, {
          mosaic_layout: _objectSpread({}, fullLayout.mosaic_layout, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, size, [_objectSpread({}, tile, {
            h: h
          })].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(lodash__WEBPACK_IMPORTED_MODULE_14___default.a.without(layout, tile)))))
...
//# sourceMappingURL=main.54536aeccaccd8e9284b.hot-update.js.map